...
function astronaut() {
  ...
  function credit(){
    ...
    textAlign(CENTER)
    fill(255)
    text('CREDITS :', width/2, height/4-50);

    textFont(font2, 45)
    textAlign(CENTER)
    fill(255)
    text('This Game is the result of hard work and dedication of ' , width/2, height/2-150)
    textFont(font2, 45)
    textAlign(CENTER)
    fill(255)
    text('two very talented and handsome students of YouCode Safi' , width/2, height/2-90)
    textFont(font2, 45)
    textAlign(CENTER)
    fill(255)
    text('Anas Benziti - Abdellah Daif' , width/2, height/2)
    textFont(font2, 30)
    textAlign(CENTER)
    fill(255)
    text('1st Edition  of the Alan Turing Game Jam' , width/2, height/2+100)
    textFont(font2, 20)
    textAlign(CENTER)
    fill(255)
    text('17th-19th April 2020' , width/2, height/2+120)
    textFont(font2, 50)
    textAlign(CENTER)
    fill(255)
    text('Press "Backspace" to go back !' , width/2, height/2+220)
  ...
  function story(){
    ...
    text('I left a newborn home, and i will never forgive you if you let me die!' , width/2, 600)
    textFont(font3, 30)
